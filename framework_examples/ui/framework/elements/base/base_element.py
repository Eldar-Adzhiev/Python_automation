...
from ....project_task1.tests.config.waits import Waits
...
class BaseElement(object):
    ...
    def scroll_by_down(self):
        Logger.info("Скролл в низ страницы")
        Browser.get_browser().execute_script("window.scrollTo(0, document.body.scrollHeight);")
